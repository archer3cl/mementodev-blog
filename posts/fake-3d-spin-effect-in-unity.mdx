...
<Image
  src="/images/post/fake-3d-spin-effect-in-unity/Final.gif"
  width="344"
  height="399"
...
One of the game devs I follow, check <UnderlineLink url="https://store.steampowered.com/app/1345860/Grapple_Dog/" text="Grapple Dog 🐶" target="_blank" />, shared a youtube channel dedicated to tutorials and other game dev content aimed for GameMaker Studio.
...
You can download the sprites used on this tutorial over Kenney <UnderlineLink url="https://kenney.nl/assets/generic-items" text="here" target="_blank" /> and <UnderlineLink url="https://kenney.nl/assets/playing-cards-pack" text="here" target="_blank" />.
...
Well, this is where <UnderlineLink url="https://en.wikipedia.org/wiki/Sine_wave" text="sine waves" target="_blank"/> come to play.
...
<Image
  src="/images/post/fake-3d-spin-effect-in-unity/Horizontal.gif"
  width="244"
  height="259"
...
<Image
  src="/images/post/fake-3d-spin-effect-in-unity/MultiSprite.gif"
  width="294"
  height="235"
